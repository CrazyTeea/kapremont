    ...
    <div id="dev_programme">
        <b-modal centered id="modal-1" title="Внимание">
            <p class="my-4">
                ...
                Выгрузка данных из системы в печатную форму «Программы модернизации» для согласования с председателем совета обучающихся и утверждения руководителем образовательной организации будет доступна с 10 марта 2020 года.</p>
        </b-modal>
        <div class="row">
            <div class="col-6">
                <b-table
