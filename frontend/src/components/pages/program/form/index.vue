    ...
    <b-form enctype="multipart/form-data" id="object_form" @submit="onSubmit" @reset="onReset" method="post">
      ...
      <div class="row mt-3">
        <div class="col-12">
          ...
          >
            <b-form-input placeholder="краткое описание планируемых работ по объекту..." id="object_opis"
                          name="ProgramObjects[object_opis]" v-model="formData.object_opis"/>
          </b-form-group>
          <b-form-group
              label="Адрес объекта"
              label-for="address"
          ...
          >
            <b-form-input placeholder="адрес..." id="address" name="ProgramObjects[address]"
          ...
          >
            <b-form-input style="display: none" id="type_remont" v-model="formData.type_remont"
            ...
            <b-collapse id="accordion-1" accordion="my-accordion" role="tabpanel" visible>
              <b-card-body>
                <b-form-group>
                  ...
                  >
                    <b-form-input style="display: none" id="id_priority" v-model="formData.id_priority"
                  ...
                  >
                    <b-form-input style="display: none" id="id_region" v-model="formData.id_region"
                  ...
                  >
                    <b-form-input style="display: none" id="id_city" v-model="formData.id_city"
                  ...
                  >
                    <b-form-input id="exploit_year" name="ProgramObjects[exploit_year]" type="number"
                  ...
                  >
                    <b-form-input id="last_exploit_year" name="ProgramObjects[last_exploit_year]" type="number"
                  ...
                  >
                    <b-form-input style="display: none;" id="exist_pred_nadz_orgs"
                                  name="ProgramObjects[exist_pred_nadz_orgs]" v-model="formData.exist_pred_nadz_orgs"/>
                  ...
                  >
                    ...
                    <b-form-input style="display: none;" id="wear" min="0" name="ProgramObjects[wear]"
                                  :state="wear_validator" type="number" v-model="formData.wear"/>
                  ...
                  >
                    <b-form-input id="osn_isp_zdan" name="ProgramObjects[osn_isp_zdan]"
                                  v-model="formData.osn_isp_zdan"/>
                  </b-form-group>
                  <b-form-group
                  ...
                  >
                    <b-form-input id="prav_oper_upr" name="ProgramObjects[prav_oper_upr]"
                                  v-model="formData.prav_oper_upr"/>
                  </b-form-group>
                  <b-form-group
                      label="Назначение:"
                  ...
                  >
                    <b-form-input style="display: none;" id="prav_sob" name="ProgramObjects[prav_sob]"
                  ...
                  >
                    <b-form-input id="square" name="ProgramObjects[square]" type="number" step="0.001"
                                  v-model="formData.square" @change="val => setFloat(val, 'square')"/>
                  </b-form-group>
                  <b-form-group
