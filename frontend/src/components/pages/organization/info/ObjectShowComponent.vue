        ...
        <div v-if="this.items.status == 5">
            ...
            <b-card no-body class="mb-1">
                ...
                <b-collapse id="accordion-plan2" accordion="my-accordion2" role="tabpanel">
                    <b-card-body>
                        <b-table-simple class="mt-3" small sticky-header bordered
                                ...
                                <div v-if="docs.length">
                                    <table class="table table-bordered">
                                        ...
                                        <tr v-for="(doc, index) in docs" :key="index">
                                            <td>{{ doc.label }}</td>
                                            <td><a :href="`/program/object/download-doc/${obj_id}?id=${doc.id}`">{{
                                                doc.name }}.pdf</a></td>
                                        </tr>
                                    </table>
                ...
                <b-card-body>
                    <div v-if="docs.length">
                        <table class="table table-bordered">
                            ...
                            <tr v-for="(doc, index) in docs" :key="index">
                                <td>{{ doc.label }}</td>
                                <td><a :href="`/program/object/download-doc/${obj_id}?id=${doc.id}`">{{ doc.name
                                    }}.pdf</a></td>
                            </tr>
                        </table>
                        <a class="btn btn-danger" target="_blank" :href="`/program/object/zip/${obj_id}`">Скачать
