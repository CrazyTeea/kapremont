<template>
  <div>
    ...
    <a v-can:root,mgsu,dep class="btn btn-warning mt-3" href="/organization/export/1">Статистика по бюджетам
      (Организация)</a>
    <a v-can:root,mgsu,dep class="btn btn-warning mt-3" href="/program-objects/export">Статистика по бюджетам
      (объект)</a>
  </div>
</template>
...
import {BBreadcrumb, BTab, BTabs} from "bootstrap-vue";
