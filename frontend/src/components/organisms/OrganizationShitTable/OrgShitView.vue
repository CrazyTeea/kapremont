                ...
                <b-card-body>
                    <b-input-group prepend="ID" class="mb-2">
                        ...
                        <b-input-group-append>
                            <b-button variant="outline-secondary" @click="filters.id_org = null"><b-icon icon="backspace" variant="danger" scale="1.2"></b-icon></b-button>
                        </b-input-group-append>
                    </b-input-group>
                    ...
                    <b-input-group prepend="Вуз" class="mb-2">
                        ...
                        <b-input-group-append>
                            <b-button variant="outline-secondary" @click="filters.org_name = null"><b-icon icon="backspace" variant="danger" scale="1.2"></b-icon></b-button>
                        </b-input-group-append>
                    </b-input-group>
