...
class ProgramObjects extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['exist_pred_nadz_orgs', 'prav_sob', 'kad_number', 'osn_isp_zdan','podrobnosti'], 'string', 'max' => 255],
            [[
    ...
    public function attributeLabels()
    {
        return [
            ...
            'square' => 'Общая площадь здания (помещений), планируемого к капитальному ремонту, кв. м.:',
